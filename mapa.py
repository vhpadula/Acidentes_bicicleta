...
lay1=folium.map.FeatureGroup(name="HeatMap", overlay=True, control=True, show=True).add_to(map_osm)
lay2=folium.map.FeatureGroup(name="Marcadoress", overlay=True, control=True, show=True).add_to(map_osm)
...
file_path = r"C:/Users/vhpad/Desktop/Acidentes_de_bicicleta.html"
